...
class Game {
    ...
    update(deltaTime) {
        ...
        this.boxes = this.boxes.filter(box => !box.destroy);
        ...
        this.actors = [this.paddlePlayer, ...this.balls, this.PowerUpMult, this.PowerUpDest, this.BorderTop, this.BorderDown, this.BorderLeft, this.BorderRight, ...this.boxes];        
        this.checkLevelUp();
